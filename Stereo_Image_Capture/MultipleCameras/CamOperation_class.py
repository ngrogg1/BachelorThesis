...
class CameraOperation():
    ...
    def Work_thread(self,index,root,panel,lock, save_img):
        ...
        while True:
            ...
            if PixelType_Gvsp_RGB8_Packed == self.st_frame_info.enPixelType:
                numArray = CameraOperation.Color_numpy(self,buf_cache,self.st_frame_info.nWidth,self.st_frame_info.nHeight)  # Data from camera is a array, resize it using Color numpy and the size of the camera pixel, then transfer them using ImageTK or Opencv will be possible
            else:
    ...
    def Save_jpg(self,buf_cache, index):
        ...
        if index == 0:
            file_path = "C:/Users/Nic/Documents/GitHub/BachelorThesis/Calibration/data/frames_stereo/frames_left/frame_" + str(self.st_frame_info.nFrameNum) + "_left.jpg"
        else:
            file_path = "C:/Users/Nic/Documents/GitHub/BachelorThesis/Calibration/data/frames_stereo/frames_right/frame_" + str(
                self.st_frame_info.nFrameNum) + "_right.jpg"
